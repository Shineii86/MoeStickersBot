...
buildah commit $c1 MoeStickersBot:base_aarch64

buildah push MoeStickersBot:base_aarch64 ghcr.io/Shineii86/MoeStickersBot:base_aarch64

fi
#################################

# Build container image.
c1=$(buildah from --arch=arm64 ghcr.io/Shineii86/MoeStickersBot:base_aarch64)
...
buildah commit $c1 MoeStickersBot:aarch64

buildah push MoeStickersBot:aarch64 ghcr.io/Shineii86/MoeStickersBot:aarch64
