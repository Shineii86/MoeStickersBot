...
Use MoeStickersBot, a Telegram bot, to easily import or download LINE/Kakaotalk/Telegram stickers, use your own image or video to create Telegram sticker set or CustomEmoji and manage it.
...
## Features/功能
  ...
  * Export Telegram stickers to WhatsApp (requires [Msb App](https://github.com/Shineii86/msb_app), supports iPhone and Android).
  * Manage your sticker set interactively through WebApp: add/move/remove/edit sticker and emoji.
  * Provides a CLI app [msbimport](https://github.com/Shineii86/MoeStickersBot/tree/master/pkg/msbimport) for downloading LINE/Kakaotalk stickers.
  ...
  * 匯出Telegram的貼圖包至WhatsApp（需要安裝[Msb App](https://github.com/Shineii86/msb_app), 支援iPhone和Android）。
  * 互動式WebApp可以輕鬆管理自己的貼圖包: 可以新增/刪除貼圖, 移動位置或修改emoji.
  * 提供名為[msbimport](https://github.com/Shineii86/MoeStickersBot/tree/master/pkg/msbimport)的終端機程式， 用於下載LINE/kakao貼圖。
...
It is recommended to deploy MoeStickersBot using containers.
A pre-built OCI container is available at https://github.com/users/Shineii86/packages/container/package/MoeStickersBot

Run:
```
docker run -dt ghcr.io/Shineii86/MoeStickersBot /MoeStickersBot --bot_token="..."
```
...
* [msb_emoji.py](https://github.com/Shineii86/MoeStickersBot/tree/master/tools/msb_emoji.py) (for extracting emoji)
* [msb_kakao_decrypt.py](https://github.com/Shineii86/MoeStickersBot/tree/master/tools/msb_kakao_decrypt.py) (for decrypting animated kakao)
* [msb_rlottie.py](https://github.com/Shineii86/MoeStickersBot/tree/master/tools/msb_rlottie.py) (for converting TGS)
...
#### WebApp
Since 2.0 version of MoeStickersBot, managing sticker set's order and emoji is achieved using Telegram's new WebApp technology. 

See details on [web/webapp](https://github.com/Shineii86/MoeStickersBot/tree/master/web/webapp3)
