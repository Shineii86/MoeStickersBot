...
你好! 歡迎使用<a href="https://github.com/Shineii86/MoeStickersBot">萌萌貼圖BOT</a>! 請：
...
https://github.com/Shineii86/MoeStickersBot</b>
...
func sendChangelog(c tele.Context) error {
	return c.Send(`
Details: 詳細:
https://github.com/Shineii86/MoeStickersBot#changelog
v2.5.0-RC1(20240528)
...
This bot is free and open source software, you can see https://github.com/Shineii86/MoeStickersBot/blob/master/core/database.go
...
本bot為自由開放原始碼軟體，請參閱 https://github.com/Shineii86/MoeStickersBot/blob/master/core/database.go
來了解bot如何儲存和處理儲存的資訊。
...
func sendConfirmExportToWA(c tele.Context, sn string, hex string) error {
	...
	return c.Reply(`
Exporting to WhatsApp requires <a href="https://github.com/Shineii86/msb_app">Msb App</a> due to their restrictions, then press "Continue export".
匯出到WhatsApp需要手機上安裝<a href="https://github.com/Shineii86/msb_app">Msb App</a>, 然後按下"繼續匯出".

Download:下載:
<b>iPhone:</b> AppStore(N/A.暫無), <a href="https://github.com/Shineii86/msb_app/releases/latest/download/msb_app.ipa">IPA</a>
<b>Android:</b> GooglePlay(N/A.暫無), <a href="https://github.com/Shineii86/msb_app/releases/latest/download/msb_app.apk">APK</a>
...
func sendFatalError(err error, c tele.Context) {
	...
	c.Send("<b>Fatal error encounterd. Please try again. /start\n"+
		...
		"You can report this error to https://github.com/Shineii86/MoeStickersBot/issues\n\n"+
